...
void main() {
  group('RouteResult Model Tests', () {
    ...
    test(
      'RouteResult mit leeren Koordinaten → als fehlerhafte Route erkennbar',
      () {
    ...
    test(
      'Route-Qualitätsprüfung: weniger als 50 Koordinaten → wird abgelehnt',
      () {
...
double _distance(List<double> a, List<double> b) {
  ...
  final x = dLon * math.cos(_toRad((a[0] + b[0]) / 2));
